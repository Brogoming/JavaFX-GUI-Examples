...
public class CSSInline extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		nameLabel.setStyle("-fx-text-fill: white"); //sets the variable to a different color
		...
		passwordLabel.setStyle("-fx-text-fill: white"); //sets the variable to a different color
